...
> 最近更新：北京时间 2026-09-16 18:02。平时打开这个主页就能看；Steam 活动需要你自己到商店领取或启动试玩。
...
> 数据来自 Steam 国区公开商店：限免搜索与官方推荐栏，每 6 小时检查。不是全站无遗漏监测；优惠可能提前结束或有地区限制，以你登录后的商店为准。商店显示的截止时间按原文保留，不擅自换算时区。
